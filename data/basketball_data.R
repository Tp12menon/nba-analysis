# =============================================================================
# NBA Basketball Dataset (2005-2014)
# =============================================================================
# Source: Kirill Eremenko / www.superdatascience.com
# Copyright: These datasets were prepared using publicly available data.
#            If you wish to use these R scripts outside of the R Programming
#            Course by Kirill Eremenko, you may do so by referencing
#            www.superdatascience.com in your work.
#
# Description:
#   Player statistics for 10 NBA stars across 10 seasons (2005-2014).
#   Seasons are labeled by the first year e.g. 2012 = 2012-2013 season.
#
# Objects created:
#   Matrices : FieldGoalAttempts, FieldGoals, Games, MinutesPlayed, Salary, Points
#   Vectors  : Players, Seasons
#
...
rm(KobeBryant_Salary, JoeJohnson_Salary, LeBronJames_Salary, CarmeloAnthony_Salary,
...
rm(KobeBryant_G, JoeJohnson_G, LeBronJames_G, CarmeloAnthony_G,
   DwightHoward_G, ChrisBosh_G, ChrisPaul_G, KevinDurant_G,
   DerrickRose_G, DwayneWade_G)
...
rm(KobeBryant_MP, JoeJohnson_MP, LeBronJames_MP, CarmeloAnthony_MP,
   DwightHoward_MP, ChrisBosh_MP, ChrisPaul_MP, KevinDurant_MP,
...
# -----------------------------------------------------------------------------
# Field Goal Attempts (shots attempted)
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# Quick sanity check (optional - remove before submitting)
# -----------------------------------------------------------------------------
# cat("Matrices loaded:", "Salary", "Games", "MinutesPlayed",
#     "FieldGoals", "FieldGoalAttempts", "Points", "\n")
# cat("Players:", Players, "\n")
# cat("Seasons:", Seasons, "\n")
